...
#
# Generated by export_simulation on Tue Mar 03 17:34:21 CST 2020
#
################################################################################
...
'-reset_run' switch to the './delaypass_0.sh' script.

./delaypass_0.sh -reset_run
...
./delaypass_0.sh -noclean_files

For more information on the script, please type './delaypass_0.sh -help'.
