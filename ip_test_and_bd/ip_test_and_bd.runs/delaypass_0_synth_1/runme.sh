...
HD_PWD='/home/petergu/MyHome/Working/PYNQ-Tutorial/ip_test_and_bd/ip_test_and_bd.runs/delaypass_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log delaypass_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source delaypass_0.tcl
